...
You may also be interested in [libocr's integration into the actual Plugin node](https://github.com/goplugin/pluginv3.0/tree/develop/core/services/offchainreporting).
